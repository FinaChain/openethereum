...
impl SpecType {
    pub fn spec<'a, T: Into<SpecParams<'a>>>(&self, params: T) -> Result<Spec, String> {
        ...
        match *self {
			...
			SpecType::FinaChain => Ok(ethereum::new_finachain(params)),
...
mod tests {
    ...
    fn test_spec_type_parsing() {
		...
		assert_eq!(SpecType::FinaChain, "finachain".parse().unwrap());
    ...
    fn test_spec_type_display() {
		...
		assert_eq!(format!("{}", SpecType::FinaChain), "finachain");
